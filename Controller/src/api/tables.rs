...
use crate::core::traffic_gen_core::const_definitions::{
    DEFAULT_FORWARD_TABLE, ETHERNET_IP_HEADER_REPLACE_TABLE, IS_EGRESS_TABLE, IS_TX_EGRESS_TABLE,
    MONITORING_FORWARD_TABLE, MPLS_HEADER_REPLACE_TABLE, PATTERN_CONFIG_TABLE, PATTERN_TABLE,
    RTT_HISTOGRAM_TABLE, STREAM_FORWARD_TABLE, VLAN_HEADER_REPLACE_TABLE,
};
use crate::AppState;
